$(document).ready(function(){
	...
	$('#wiki-preview').hover(function(){
		...
		$("#project-description").html("Wiki-Preview is a google chrome extension that gives you a preview of a wiki page as a tooltip. By providing a tooltip, one's flow of reading isn't interrupted as much and improves the reading experience. This is also available on the chrome store."); 
		$('.center-icon > a > i').show();
